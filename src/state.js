...
export const state = {
  ...
  models: {
    available: [
      { id:'mistral-7b-lite', webllmId:'Mistral-7B-Instruct-v0.3-q4f16_1-MLC', name:'Mistral 7B Lite', desc:'Fast general-purpose chat model', size:'3.8 GB', ram:'4 GB', perf:'fast', category:'chat', color:'#8b5cf6', installed:true, benchmarks:{speed:92,quality:75,reasoning:70}, useCases:['General chat','Quick Q&A','Summarization'] },
      { id:'phi-3-mini', webllmId:'Phi-3-mini-4k-instruct-q4f16_1-MLC', name:'Phi-3 Mini', desc:'Compact and efficient reasoning model', size:'2.3 GB', ram:'3 GB', perf:'fast', category:'chat', color:'#3b82f6', installed:true, benchmarks:{speed:95,quality:70,reasoning:72}, useCases:['Reasoning','Math','Logic puzzles'] },
      ...
      { id:'llama3-8b', webllmId:'Llama-3-8B-Instruct-q4f32_1-MLC', name:'Llama 3 8B', desc:'High-quality open-source all-rounder', size:'5.1 GB', ram:'6 GB', perf:'powerful', category:'chat', color:'#f59e0b', installed:false, benchmarks:{speed:65,quality:90,reasoning:88}, useCases:['Complex reasoning','Creative writing','Analysis'] },
      { id:'gemma-2b', webllmId:'gemma-2b-it-q4f16_1-MLC', name:'Gemma 2B', desc:'Ultra-light model for basic tasks', size:'1.4 GB', ram:'2 GB', perf:'fast', category:'chat', color:'#ec4899', installed:false, benchmarks:{speed:98,quality:55,reasoning:50}, useCases:['Simple chat','Quick answers','Low-end devices'] },
      ...
      { id:'tinyllama-1b', webllmId:'TinyLlama-1.1B-Chat-v1.0-q4f16_1-MLC', name:'TinyLlama 1.1B', desc:'Tiny but capable study companion', size:'0.8 GB', ram:'1.5 GB', perf:'fast', category:'study', color:'#06b6d4', installed:false, benchmarks:{speed:99,quality:45,reasoning:40}, useCases:['Flashcards','Simple Q&A','Definitions'] },
...
export let aiEngine = null;
export function setAiEngine(engine) {
  aiEngine = engine;
}
